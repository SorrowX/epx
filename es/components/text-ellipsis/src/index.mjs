import { defineComponent, ref, computed, onMounted, nextTick, onActivated, watch, h } from 'vue';
import { useNamespace, ElTooltip } from 'element-plus';
import { textEllipsisProps, textEllipsisEmits } from './text-ellipsis.mjs';
import { useWindowSize } from '../../../hooks/use-window-size/index.mjs';

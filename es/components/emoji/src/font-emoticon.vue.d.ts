...
declare const _default: import("vue").DefineComponent<import("vue").ExtractPropTypes<{
    ...
    change: (item: import("./helper").EmoticonListItem | FontEmoticonListItem, type: string) => void;
    ...
    onChange?: ((item: import("./helper").EmoticonListItem | FontEmoticonListItem, type: string) => any) | undefined;
